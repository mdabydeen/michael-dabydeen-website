...
"Change is here!" That is the banner under which [Canonical](https://www.canonical.com/) is marketing their latest addition to the table called Lucid Lynx, Ubuntu 10.04 LTS (Long Term Support).
...
[Ubuntu](https://www.ubuntu.com/), if you don't know already, is a distribution of GNU/Linux and is based on Debian.
...
Lucid Lynx is loaded with new features. Enough to make you very excited about it, enough to make you want to download it and try it out immediately. All of the new features are listed on [Ubuntu's Website](https://www.ubuntu.com/products/whatisubuntu/1004features)
...
1.  Jorge, "Announcing Ubuntu 10.04 LTS: The Lucid Lynx".The Ubuntu Fridge. [http://fridge.ubuntu.com/node/1916 ](https://fridge.ubuntu.com/node/1916)(visited 29 April, 2010)
