...
export const MDWelcomeEmail = () => (
  <Html>
    <Head />
    <Preview>
      You&apos;re now ready to recieve updates from Mike&apos;s website!
    </Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          <Img
            src={`${baseUrl}/static/mike.png`}
            width="49"
            height="21"
            alt="Mike Dabydeen"
          />
          ...
          <Text style={paragraph}>
            ...
            ready to to recieve updates from Mike&apos;s website!
          </Text>
          <Text style={paragraph}>
          ...
          <Text style={paragraph}>— Mike Dabydeen</Text>
          <Hr style={hr} />
          <Text style={footer}>MichaelDabydeen.com</Text>
        </Section>
      </Container>
    </Body>
  </Html>
